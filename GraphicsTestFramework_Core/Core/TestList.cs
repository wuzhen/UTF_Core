...
namespace GraphicsTestFramework
{
    public class TestList : MonoBehaviour
    {
        ...
        public void RunTest(TestInstance inputTest, RunnerType runnerType)
        {
            ...
            if (!Master.Instance.GetComponent(activeModelInstance.logic))
                activeTestLogic = (TestLogicBase)Master.Instance.gameObject.AddComponent(activeModelInstance.logic);
            else
                activeTestLogic = (TestLogicBase)Master.Instance.gameObject.GetComponent(activeModelInstance.logic);

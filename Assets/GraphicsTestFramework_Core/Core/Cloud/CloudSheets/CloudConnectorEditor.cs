...
public class CloudConnectorEditor
{
	...
	private static string spreadsheetId = "1oobsp91E_H8vswnzWMaa1N12IFmx_yXexOvZqe7RllQ"; // If this is a fixed value could also be setup on the webservice to save POST request size.
